...
const ApplicantList = () => {
  ...
  useEffect(() => {
    const fetchApplicants = async () => {
      try {
        ...
        const response = await axiosInstance.get("/api/applicants"); // 엔드포인트 수정 필요
  ...
  return (
    <div className="w-[393px] min-h-[852px] max-h-screen flex flex-col bg-white shadow-lg overflow-hidden">
      {/* ✅ 지원자 목록 */}
